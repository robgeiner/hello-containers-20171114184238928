...
if [ "$OSTYPE" != "darwin"* ] && [ ! -z $(curl -s http://169.254.169.254/1.0/ --connect-timeout 2) ]; then
    ...
    ghprbActualCommitAuthor="${ghprbActualCommitAuthor}"
    ghprbActualCommitAuthorEmail="${ghprbActualCommitAuthorEmail}"
    ghprbAuthorRepoGitUrl="${ghprbAuthorRepoGitUrl}"
    ghprbTriggerAuthor="${ghprbTriggerAuthor}"
    ghprbTriggerAuthorEmail="${ghprbTriggerAuthorEmail}"
    ghprbTriggerAuthorLogin="${ghprbTriggerAuthorLogin}"
    ghprbTriggerAuthorLoginMention="${ghprbTriggerAuthorLoginMention}"
    ghprbPullId="${ghprbPullId}"
    ghprbTargetBranch="${ghprbTargetBranch}"
    ghprbSourceBranch="${ghprbSourceBranch}"
    ghprbPullAuthorEmail="${ghprbPullAuthorEmail}"
    ghprbPullAuthorLogin="${ghprbPullAuthorLogin}"
    ghprbPullAuthorLoginMention="${ghprbPullAuthorLoginMention}"
    ghprbPullDescription="${ghprbPullDescription}"
    ghprbPullTitle="${ghprbPullTitle}"
    ghprbPullLink="${ghprbPullLink}"
    ghprbPullLongDescription="${ghprbPullLongDescription}"
    ghprbCommentBody="${ghprbCommentBody}"
    ghprbGhRepository="${ghprbGhRepository}"
    ghprbCredentialsId="${ghprbCredentialsId}"
    echo "==PR Info============================================================"
    echo "Commit #: ${ghprbActualCommit}"
    echo "ActualCommitAuthor: ${ghprbActualCommitAuthor}"
    echo "ActualCommitAuthorEmail: ${ghprbActualCommitAuthorEmail}"
    echo "AuthorRepoGitUrl: ${ghprbAuthorRepoGitUrl}"
    echo "TriggerAuthor: ${ghprbTriggerAuthor}"
    echo "TriggerAuthorEmail: ${ghprbTriggerAuthorEmail}"
    echo "TriggerAuthorLogin: ${ghprbTriggerAuthorLogin}"
    echo "TriggerAuthorLoginMention: ${ghprbTriggerAuthorLoginMention}"
    echo "PullId: ${ghprbPullId}"
    echo "TargetBranch: ${ghprbTargetBranch}"
    echo "SourceBranch: ${ghprbSourceBranch}"
    echo "PullAuthorEmail: ${ghprbPullAuthorEmail}"
    echo "PullAuthorLogin: ${ghprbPullAuthorLogin}"
    echo "PullAuthorLoginMention: ${ghprbPullAuthorLoginMention}"
    echo "PullDescription: ${ghprbPullDescription}"
    echo "PullTitle: ${ghprbPullTitle}"
    echo "PullLink: ${ghprbPullLink}"
    echo "PullLongDescription: ${ghprbPullLongDescription}"
    echo "CommentBody: ${ghprbCommentBody}"
    echo "GhRepository: ${ghprbGhRepository}"
    echo "CredentialsId: ${ghprbCredentialsId}"
    echo "====================================================================="
else
