...
output "chef_api_region_hostname" { value = "${var.chef_api_name}-${var.ENVIRONMENT}-${var.REGION}.${data.terraform_remote_state.route53.domain}" }
output "chef_api_global_hostname" { value = "${var.chef_api_name}.${data.terraform_remote_state.route53.domain}" }
